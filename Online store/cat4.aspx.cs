...
{
    public partial class cat4 : System.Web.UI.Page
    {
        ...
        public static string cat4getproductlist(string orderby)
        {

            cat4 obj = new cat4();
            List<ProductList> allproduct = new List<ProductList>();
            allproduct = obj.cat4GetproductsfromDB();
            string json = JsonConvert.SerializeObject(allproduct);
            return json;
        }
        public List<ProductList> cat4GetproductsfromDB()
        {
            ...
            try
            {
                ...
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    string query = "Select * from products where category_id=1 ";

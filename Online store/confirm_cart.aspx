<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="confirm_cart.aspx.cs" Inherits="project_website.confirm_cart" %>
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.3/jquery.min.js"></script>
       ...
       <script type="text/javascript">
           $(document).ready(function ()
           {
               ...
               if (issession == "true") {
                   $.ajax({
                       url: "confirm_cart.aspx/getproductlist",
                       type: "POST",
                           ...
                           if (response.d != "") {
                               ...
                               for (let i = 0; i < productList.length; i++) {
                                   ...
                                   HTLM = HTLM +
                                       ...
                                       '<td><button value = ' + product.id + ' class="btn btn-success btn-sm"><i class="fas fa-trash-alt"></i></button></td></tr>'
               ...
               $(".btn-danger ").click(function ()
               {
                   ...
                   alert(product_id);
                   $.ajax({
                       url: "confirm_cart.aspx/delproduct",
                       type: "POST",

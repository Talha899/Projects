...
{
    public partial class cat3 : System.Web.UI.Page
    {
        ...
        public static string cat3getproductlist(string orderby)
        {

            cat3 obj = new cat3();
            List<ProductList> allproduct = new List<ProductList>();
            allproduct = obj.cat3GetproductsfromDB();
            string json = JsonConvert.SerializeObject(allproduct);
            return json;
        }
        public List<ProductList> cat3GetproductsfromDB()
        {
            ...
            try
            {
                ...
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    string query = "Select * from products where category_id=7 ";

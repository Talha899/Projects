...
{
    public partial class cat6 : System.Web.UI.Page
    {
        ...
        public static string cat6getproductlist(string orderby)
        {

            cat6 obj = new cat6();
            List<ProductList> allproduct = new List<ProductList>();
            allproduct = obj.cat6GetproductsfromDB();
            string json = JsonConvert.SerializeObject(allproduct);
            return json;
        }
        public List<ProductList> cat6GetproductsfromDB()
        {
            ...
            try
            {
                ...
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    string query = "Select * from products where category_id=3 ";

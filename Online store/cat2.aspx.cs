...
namespace project_website
{
    public partial class cat2 : System.Web.UI.Page
    {
        ...
        public static string cat2getproductlist(string orderby)
        {

            cat2 obj = new cat2();
            List<ProductList> allproduct = new List<ProductList>();
            allproduct = obj.cat2GetproductsfromDB();
            string json = JsonConvert.SerializeObject(allproduct);
            return json;
        }
        public List<ProductList> cat2GetproductsfromDB()
        {
            ...
            try
            {
                ...
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    string query = "Select * from products where category_id=8 ";

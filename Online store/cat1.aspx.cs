...
{
    public partial class cat1 : System.Web.UI.Page
    {
        ...
        public static string cat1getproductlist(string orderby)
        {

            cat1 obj = new cat1();
            List<ProductList> allproduct = new List<ProductList>();
            allproduct = obj.cat1GetproductsfromDB();
            string json = JsonConvert.SerializeObject(allproduct);
            return json;
        }
        public List<ProductList> cat1GetproductsfromDB()
        {
            ...
            try
            {
                ...
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    string query = "Select * from products where category_id=4 ";

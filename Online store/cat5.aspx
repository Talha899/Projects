<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cat5.aspx.cs" Inherits="project_website.cat5" %>
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.3/jquery.min.js"></script>
       ...
       <script type="text/javascript">
           ...
           {
                   $.ajax({
                       url: "cat5.aspx/cat5getproductlist",
                       type: "POST",
      ...
      <section class="banner_main">
         <div class="container">
            <div class="row">
               <div class="col-md-8">
                  <div class="text-bg">
                     <h1> <span class="blodark"> Better Buys </span> <br>Shop till you drop</h1>
                     <p>A huge fashion collection for every individual </p>
                     <a class="read_more" href="#">Shop now</a>
                  </div>
               </div>
               <div class="col-md-4">
                  <div class="ban_img">
                      <img src="images/ban_img.png" alt="#" style="width: 700px; height: 600px;">
                  </div>
               </div>
            </div>
         </div>
         ...
         <div class="container-fluid">
           ...
           <a href="cat1.aspx">
             <div class="six_probpx yellow_bg">
              <i><img src="images/shoes.png" alt="Shoes"/></i>
             <span>Shoes</span>
                </div>
            </a>
    ...
    <div class="col-md-2 col-sm-4 pa_left">
           <a href="cat2.aspx">
             <div class="six_probpx bluedark_bg">
              <i><img src="images/womencat.png" alt="watch"/></i>
             <span>watch</span>
                </div>
            </a>
               </div>
    <div class="col-md-2 col-sm-4 pa_left">
           <a href="cat3.aspx">
             <div class="six_probpx yellow_bg">
              <i><img src="images/pent.png" alt="pent"/></i>
             <span>pents</span>
                </div>
            </a>
               </div>
    <div class="col-md-2 col-sm-4 pa_left">
           <a href="cat4.aspx">
             <div class="six_probpx bluedark_bg">
              <i><img src="images/t_shart.png" alt="t_shart"/></i>
    ...
    <div class="col-md-2 col-sm-4 pa_left">
           <a href="cat5.aspx">
             <div class="six_probpx yellow_bg">
              <i><img src="images/jakit.png" alt="jakit"/></i>
    ...
    <div class="col-md-2 col-sm-4 pa_left">
           <a href="cat6.aspx">
             <div class="six_probpx bluedark_bg">
              <i><img src="images/helbet.png" alt="helbet"/></i>
             <span>Top & hat</span>
                </div>
            </a>
               </div>  

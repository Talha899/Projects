<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cart.aspx.cs" Inherits="project_website.Cart" %>
                       ...
                       success: function (response) {
                           ...
                           if (response.d != "") {
                               ...
                               for (let i = 0; i < productList.length; i++) {
                                   ...
                                   HTLM = HTLM +
                                       '<tr> <td><img style="width:110px " src=' + product.imglink + ' alt="Product 1"> </td> ' +
                                       ' <td> <div class="product-details"> <h4>' + product.name + '</h4 ><p>Color:' + product.color + ' </p>  </div> </td> ' +
                                       '<td> $' + product.price + '</td>' +
                                       '<td> $' + tprice + '</td>' +

                                       '<td>' + product.quantity + '</td>' +
                                       '<td><button value = ' + product.id + ' class="btn btn-danger btn-sm"><i class="fas fa-trash-alt"></i></button></td></tr>'

                               }
                               $('#order_table').html(HTLM)
        ...
        <div class="row justify-content-center mt-5">
            <div class="col-lg-8">
                ...
                <div class="text-center">
                    ...
                    <a href="order_confirmed.aspx" class="btn btn-success">Checkout</a>
                </div>
            </div>
        </div>
    </div>
